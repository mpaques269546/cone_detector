...
def segment(args):
    ...
    val_transform = MyTransform(hflip=False, vflip=False, rcrop=False, ccrop=True, colorjitter=False, size=args.image_size, normalize=True)
    train_transform = MyTransform(hflip=True, vflip=False, rcrop=True, ccrop=False, colorjitter=True, size=args.image_size, normalize=True)
    infer_transform = MyTransform(hflip=False, vflip=False, rcrop=False, ccrop=True, colorjitter=False, size=args.image_size, normalize=True)
    
    dataset_val =   MyDataset(args.data_path+'val/', val_transform,  )
    dataset_train = MyDataset(args.data_path+'train/', train_transform  )
    dataset_infer = MyDataset(args.data_path+'test/', infer_transform )
...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('--data_path', default='datasets/cone/', type=str)
